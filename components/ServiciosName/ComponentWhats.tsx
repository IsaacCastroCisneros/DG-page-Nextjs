                ...
                <div className='w-full lg:w-[70%]'>
                    ...
                    <div className='w-full flex justify-center items-center'>
                        <div className="bg-white w-[300px] rounded-md p-5 relative mt-20">
                            <Image src="/img/icons/WhatsAppIcon.webp" alt='logo whatsapp' width={90} height={90} className='absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2' />
                            ...
                            <a className='flex border-2 border-green-500 rounded-full w-[202px] mx-auto items-center  relative h-[40px] mt-1' href='google.ocm'>
                                <Image src="/img/icons/WhatsAppIcon.webp" alt='logo whatsapp' width={44} height={44} className='absolute left-0' />
