            ...
            <article className="text-white container mx-auto">
                <div className="w-full lg:w-[70%] xl:w-[70%] 2xl:w-[70%] ">
                    ...
                    <div className='mt-10 grid grid-cols-[repeat(auto-fill,minmax(17.3rem,1fr))] gap-5'>
                        <div className='bg-[#ffc107] rounded-md w-[280px] h-[376px] mx-auto p-7 text-black'>
                            <Image src="/img/icons/12anos.webp" alt='12 años capacitando' width="210" height="66" className='py-5' />
                            <p className='font-bold text-base'>Experiencia Comprobada</p>
                            <p>12 años Capacitando en la Gestión Pública y miles de alumnos satisfechos, tanto en capacitaciones presenciales y virtuales.</p>
                        </div>
                        <div className='bg-[#dc3545] rounded-md w-[280px] h-[376px] mx-auto p-7'>
                        ...
                        <div className='bg-[#282828] rounded-md w-[280px] h-[376px] mx-auto p-7'>
                        ...
                        <div className='bg-white text-black rounded-md w-[280px] h-[376px] mx-auto p-7'>
